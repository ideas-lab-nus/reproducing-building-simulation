...
random value in ± `r scales::percent(offset)` of the "real" value.
...
path_epw_tmy3 <- here("data-raw/epw/TMY3/PA_PHILADELPHIA_720304_14-13.epw")
...
space_param <- dplyr::tribble(
    ~parameter                 , ~lower                   , ~upper                   ,
     "conductivity"            , real_conductivity  * lower , real_conductivity  * upper ,
     "density"                 , real_density       * lower , real_density       * upper ,
     "specific_heat"           , real_specific_heat * lower , real_specific_heat * upper ,
     "u_value"                 , real_u_value       * lower , real_u_value       * upper ,
     "SHGC"                    , real_SHGC          * lower , real_SHGC          * upper ,
     "infiltration"            , real_infiltration  * lower , real_infiltration  * upper ,
     "people"                  , real_people        * lower , real_people        * upper ,
     "lpd"                     , real_lpd           * lower , real_lpd           * upper ,
     "epd"                     , real_epd           * lower , real_epd           * upper ,
     "cooling"                 , real_clg_sp        * lower , real_clg_sp        * upper ,
     "heating"                 , real_htg_sp        * lower , real_htg_sp        * upper
)

# define setup values
MU <- 4L      # number of individuals per generation
LAMBDA <- 10L # number of generations
